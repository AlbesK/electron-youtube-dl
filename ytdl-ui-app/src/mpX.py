...
directory = SAVE_PATH + "/Youtube-DL-UI"
if (os.path.exists(directory)==False):
    os.mkdir(directory) 
print("Directory '% s' created" % directory) 
print("Output will be saved at: {}".format(directory))
...
if download_method == "mp4" :
    ...
    'outtmpl': directory + '/%(title)s.%(ext)s',    # name the file the ID of the video
    ...
    options = {
        ...
        'outtmpl':directory + '/%(title)s.%(ext)s',    # 'o': u'../%(title)s.%(ext)s',
